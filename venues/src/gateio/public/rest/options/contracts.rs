...
const ENDPOINT_OPTIONS_CONTRACTS: &str = "/options/contracts";
...
impl RestClient {
    ...
    ///
    /// # API Documentation
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#list-all-the-contracts-with-specified-underlying-and-expiration-time)
    pub async fn get_options_contracts(
        &self,
        params: OptionsContractsRequest,
    ) -> RestResult<Vec<OptionsContract>> {
        self.get_with_query(ENDPOINT_OPTIONS_CONTRACTS, Some(&params))
            .await
    }
