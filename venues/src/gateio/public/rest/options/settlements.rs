...
impl RestClient {
    ...
    ///
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#list-settlement-history)
    pub async fn get_options_settlements(
        &self,
        params: OptionsSettlementsRequest,
    ) -> RestResult<Vec<OptionsSettlement>> {
    ...
    ///
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#get-specified-contract-s-settlement)
    pub async fn get_options_contract_settlement(
        &self,
        contract: &str,
    ) -> RestResult<OptionsSettlement> {
