...
impl RestClient {
    ...
    pub async fn get_options_order_book(&self, params: OptionsOrderBookRequest) -> crate::gateio::Result<OptionsOrderBook> {
        self.get_with_query("/options/order_book", Some(&params)).await
    }
}