...
impl RestClient {
    ...
    pub async fn get_delivery_contracts(&self, params: DeliveryContractsRequest) -> crate::gateio::Result<Vec<DeliveryContract>> {
    ...
    pub async fn get_delivery_contract(&self, params: DeliveryContractRequest) -> crate::gateio::Result<DeliveryContract> {
