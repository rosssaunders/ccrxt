...
impl RestClient {
    ...
    pub async fn get_options_contracts(&self, params: OptionsContractsRequest) -> crate::gateio::Result<Vec<OptionsContract>> {
        self.get_with_query("/options/contracts", Some(&params)).await
    }
    
    /// Query specified contract detail
    ///
    /// Retrieves detailed information for a specific options contract.
    pub async fn get_options_contract(&self, contract: &str) -> crate::gateio::Result<OptionsContract> {
