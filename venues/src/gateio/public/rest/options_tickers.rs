...
impl RestClient {
    ...
    pub async fn get_options_tickers(&self, params: OptionsTickersRequest) -> crate::gateio::Result<Vec<OptionsTicker>> {
    ...
    pub async fn get_underlying_ticker(&self, underlying: &str) -> crate::gateio::Result<UnderlyingTicker> {
