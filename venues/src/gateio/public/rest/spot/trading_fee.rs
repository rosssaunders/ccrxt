...
impl RestClient {
    ...
    ///
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#query-user-trading-fee-rates)
    pub async fn get_trading_fee(&self, params: TradingFeeRequest) -> RestResult<TradingFee> {
    ...
    pub async fn get_batch_trading_fee(&self) -> RestResult<Vec<BatchTradingFee>> {
