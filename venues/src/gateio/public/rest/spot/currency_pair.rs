...
impl RestClient {
    ...
    ///
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#get-details-of-a-specifc-currency-pair)
    pub async fn get_currency_pair(&self, currency_pair: &str) -> RestResult<CurrencyPair> {
