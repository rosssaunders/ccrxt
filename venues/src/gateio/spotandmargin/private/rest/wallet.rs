...
impl RestClient {
    ...
    ) -> crate::gateio::spotandmargin::Result<TotalBalance> {
    ...
    ) -> crate::gateio::spotandmargin::Result<DepositAddress> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<DepositRecord>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<WithdrawalRecord>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<TransferRecord> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<WithdrawalFee>> {
