...
impl RestClient {
    ...
    ) -> crate::gateio::spotandmargin::Result<BorrowOrRepayResponse> {
    ...
    pub async fn get_max_borrowable(
        &self,
        currency: &str,
    ) -> crate::gateio::spotandmargin::Result<MaxBorrowable> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<LoanInterestRecord>> {
