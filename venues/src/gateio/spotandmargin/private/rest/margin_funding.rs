...
impl RestClient {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<FundingAccount>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<TransferableAmount> {
    ...
    ) -> crate::gateio::spotandmargin::Result<BorrowableAmount> {
    ...
    pub async fn get_auto_repay(&self) -> crate::gateio::spotandmargin::Result<AutoRepaySetting> {
    ...
    ) -> crate::gateio::spotandmargin::Result<AutoRepaySetting> {
