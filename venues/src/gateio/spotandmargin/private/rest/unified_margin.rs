...
impl RestClient {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<UnifiedMarginCurrencyPair>> {
    ...
    pub async fn get_unified_margin_currency_pair(
        &self,
        currency_pair: &str,
    ) -> crate::gateio::spotandmargin::Result<UnifiedMarginCurrencyPair> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<UnifiedMarginLoan>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<UnifiedMarginLoan> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<UnifiedMarginLoanRecord>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<UnifiedMarginBorrowable> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<UnifiedMarginInterestRecord>> {
