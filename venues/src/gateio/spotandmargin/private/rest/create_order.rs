...
use crate::gateio::spotandmargin::{OrderSide, OrderStatus, OrderType, StpMode, TimeInForce};
...
mod tests {
    use super::*;
    use crate::gateio::spotandmargin::enums::{OrderSide, OrderType, TimeInForce};
