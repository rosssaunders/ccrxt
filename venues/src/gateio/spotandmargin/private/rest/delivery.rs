...
pub type DeliveryTrade = crate::gateio::spotandmargin::public::rest::delivery_trades::DeliveryTrade;
...
impl RestClient {
    ...
    ) -> crate::gateio::spotandmargin::Result<DeliveryAccount> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<DeliveryPosition>> {
    ...
    pub async fn get_delivery_position(
        ...
        settle: &str,
        contract: &str,
    ) -> crate::gateio::spotandmargin::Result<DeliveryPosition> {
    ...
    ) -> crate::gateio::spotandmargin::Result<DeliveryOrder> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<DeliveryOrder>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<DeliveryLeverageResponse> {
        let endpoint = format!(
    ...
    pub async fn get_delivery_settlements(
        ...
        contract: Option<&str>,
        limit: Option<i32>,
    ) -> crate::gateio::spotandmargin::Result<Vec<DeliverySettlement>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<DeliveryPositionMarginResponse> {
        let endpoint = format!(
    ...
    ) -> crate::gateio::spotandmargin::Result<DeliveryRiskLimitResponse> {
        let endpoint = format!(
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<DeliveryPositionClose>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<DeliveryLiquidation>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<DeliveryAccountBookEntry>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<DeliveryPriceOrder> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<DeliveryPriceOrder>> {
