...
impl RestClient {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<Loan>> {
    ...
    pub async fn get_loan(&self, loan_id: &str) -> crate::gateio::spotandmargin::Result<Loan> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Loan> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<LoanRepayment>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<LoanRecord>> {
    ...
    pub async fn get_loan_record(
        ...
        loan_record_id: &str,
        params: LoanRecordsRequest,
    ) -> crate::gateio::spotandmargin::Result<LoanRecord> {
