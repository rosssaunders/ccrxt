...
impl RestClient {
    ...
    pub async fn get_options_accounts(
        &self,
    ) -> crate::gateio::spotandmargin::Result<OptionsAccount> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<OptionsPosition>> {
    ...
    pub async fn get_options_position(
        &self,
        contract: &str,
    ) -> crate::gateio::spotandmargin::Result<OptionsPosition> {
    ...
    ) -> crate::gateio::spotandmargin::Result<OptionsOrder> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<OptionsOrder>> {
    ...
    pub async fn get_mmp_settings(
        &self,
        underlying: &str,
    ) -> crate::gateio::spotandmargin::Result<MMPSettings> {
    ...
    pub async fn reset_mmp(&self, underlying: &str) -> crate::gateio::spotandmargin::Result<()> {
    ...
    pub async fn get_options_settlements(
        ...
        underlying: Option<&str>,
        limit: Option<i32>,
    ) -> crate::gateio::spotandmargin::Result<Vec<OptionsSettlement>> {
    ...
    pub async fn get_user_options_settlements(
        &self,
        underlying: Option<&str>,
        limit: Option<i32>,
    ) -> crate::gateio::spotandmargin::Result<Vec<OptionsSettlement>> {
    ...
    pub async fn get_options_account_book(
        &self,
        params: OptionsAccountBookRequest,
    ) -> crate::gateio::spotandmargin::Result<Vec<OptionsAccountBookEntry>> {
    ...
    pub async fn get_options_position_close_history(
        &self,
        params: OptionsPositionCloseRequest,
    ) -> crate::gateio::spotandmargin::Result<Vec<OptionsPositionClose>> {
        self.get_with_query("/options/position_close", &params)
            .await
    }
    ...
    pub async fn get_options_my_trades(
        &self,
        params: OptionsMyTradesRequest,
    ) -> crate::gateio::spotandmargin::Result<Vec<OptionsMyTrade>> {
    ...
    pub async fn countdown_cancel_options_orders(
        ...
        timeout: i32,
        underlying: Option<&str>,
    ) -> crate::gateio::spotandmargin::Result<serde_json::Value> {
