...
impl RestClient {
    ...
    pub async fn get_unified_mode(
        &self,
    ) -> crate::gateio::spotandmargin::Result<UnifiedModeResponse> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<UnifiedCurrency>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<UnifiedBorrowableResponse> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<BatchBorrowableResponse>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<UnifiedTransferableResponse> {
    ...
    pub async fn get_unified_transferables(
        &self,
    ) -> crate::gateio::spotandmargin::Result<Vec<UnifiedTransferableResponse>> {
    ...
    pub async fn get_currency_discount_tiers(
        &self,
    ) -> crate::gateio::spotandmargin::Result<Vec<CurrencyDiscountTier>> {
    ...
    pub async fn get_loan_margin_tiers(
        &self,
    ) -> crate::gateio::spotandmargin::Result<Vec<LoanMarginTier>> {
    ...
    pub async fn get_risk_units(&self) -> crate::gateio::spotandmargin::Result<Vec<RiskUnit>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<RateEstimate>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<HistoricalLoanRate>> {
    ...
    pub async fn get_leverage_user_currency_config(
        &self,
        currency: Option<&str>,
    ) -> crate::gateio::spotandmargin::Result<Vec<LeverageConfig>> {
    ...
    pub async fn get_leverage_user_currency_setting(
        &self,
        currency: &str,
    ) -> crate::gateio::spotandmargin::Result<LeverageConfig> {
        let endpoint = format!(
    ...
    ) -> crate::gateio::spotandmargin::Result<PortfolioCalculationResult> {
