...
impl RestClient {
    ...
    ) -> crate::gateio::spotandmargin::Result<FuturesAccount> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<FuturesPosition>> {
    ...
    pub async fn get_futures_position(
        ...
        settle: &str,
        contract: &str,
    ) -> crate::gateio::spotandmargin::Result<FuturesPosition> {
    ...
    ) -> crate::gateio::spotandmargin::Result<FuturesOrder> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<FuturesOrder>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<LeverageResponse> {
        let endpoint = format!(
    ...
    ) -> crate::gateio::spotandmargin::Result<PositionMarginResponse> {
        let endpoint = format!(
    ...
    ) -> crate::gateio::spotandmargin::Result<RiskLimitResponse> {
        let endpoint = format!(
    ...
    pub async fn switch_to_cross_margin(
        &self,
        settle: &str,
    ) -> crate::gateio::spotandmargin::Result<()> {
    ...
    ) -> crate::gateio::spotandmargin::Result<DualModeResponse> {
    ...
    pub async fn get_dual_mode_position(
        ...
        settle: &str,
        contract: &str,
    ) -> crate::gateio::spotandmargin::Result<DualModePosition> {
    ...
    ) -> crate::gateio::spotandmargin::Result<DualModeMarginResponse> {
        let endpoint = format!(
    ...
    ) -> crate::gateio::spotandmargin::Result<DualModeLeverageResponse> {
        let endpoint = format!(
    ...
    ) -> crate::gateio::spotandmargin::Result<DualModeRiskLimitResponse> {
        let endpoint = format!(
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<BatchOrderResult>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<CountdownCancelResponse> {
    ...
    ) -> crate::gateio::spotandmargin::Result<PriceOrder> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<PriceOrder>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<FuturesTrade>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<PositionClose>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<Liquidation>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<LiquidationOrder>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<AutoDeleveraging>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<Vec<FuturesAccountBookEntry>> {
    ...
    ) -> crate::gateio::spotandmargin::Result<FuturesFeeRates> {
