...
mod tests {
    ...
    fn test_insurance_fund_growth_scenario() {
        let entries = [r#"{"t": 1641024000, "b": 5000000.0}"#,
    ...
    fn test_insurance_fund_drawdown_scenario() {
        let entries = [r#"{"t": 1641024000, "b": 10000000.0}"#,
    ...
    fn test_hourly_snapshots() {
        let hourly_entries = [(1641024000, 5000000.0, "00:00"),
    ...
    fn test_daily_snapshots() {
        let daily_entries = [(1640995200, 20000000.0, "2022-01-01"),
