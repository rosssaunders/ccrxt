...
impl RestClient {
    ...
    pub async fn list_price_orders(&self, params: ListPriceOrdersRequest) -> crate::gateio::Result<Vec<PriceOrder>> {
    ...
    pub async fn create_price_order(&self, request: CreatePriceOrderRequest) -> crate::gateio::Result<PriceOrder> {
    ...
    pub async fn cancel_all_price_orders(&self, currency_pair: &str, account: &str) -> crate::gateio::Result<Vec<PriceOrder>> {
        let endpoint = format!("/spot/price_orders?currency_pair={}&account={}", currency_pair, account);
