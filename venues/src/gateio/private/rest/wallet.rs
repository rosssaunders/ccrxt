...
impl RestClient {
    ...
    pub async fn get_total_balance(&self, params: TotalBalanceRequest) -> crate::gateio::Result<TotalBalance> {
    ...
    pub async fn get_deposit_address(&self, params: DepositAddressRequest) -> crate::gateio::Result<DepositAddress> {
        self.get_with_query("/wallet/deposit_address", &params).await
    }
    
    /// Get deposit history
    /// 
    /// This endpoint returns the deposit history for the authenticated user.
    pub async fn get_deposits(&self, params: DepositsRequest) -> crate::gateio::Result<Vec<DepositRecord>> {
    ...
    pub async fn get_withdrawals(&self, params: WithdrawalsRequest) -> crate::gateio::Result<Vec<WithdrawalRecord>> {
    ...
    pub async fn create_transfer(&self, request: CreateTransferRequest) -> crate::gateio::Result<TransferRecord> {
    ...
    pub async fn get_withdrawal_fees(&self, params: WithdrawalFeesRequest) -> crate::gateio::Result<Vec<WithdrawalFee>> {
