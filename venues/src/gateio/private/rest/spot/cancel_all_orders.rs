...
impl RestClient {
    ...
    /// orders are canceled.
    ///
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#cancel-all-open-orders-in-specified-currency-pair)
    ///
    ...
    pub async fn spot_cancel_all_orders(
        &self,
    ...
    /// # Returns
    /// A vector of canceled orders with their details
    pub async fn spot_cancel_all_orders_for_pair(
        &self,
        currency_pair: &str,
    ) -> RestResult<Vec<Order>> {
        ...
        self.spot_cancel_all_orders(request).await
    }
}
