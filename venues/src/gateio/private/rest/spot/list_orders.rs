...
use super::{OrderSide, OrderStatus, RestClient, RestResult, create_order::Order};
...
impl RestClient {
    ...
    pub async fn spot_list_orders(&self, request: ListOrdersRequest) -> RestResult<Vec<Order>> {
