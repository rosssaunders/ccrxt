...
impl RestClient {
    ...
    pub async fn get_delivery_accounts(&self, params: DeliveryAccountsRequest) -> crate::gateio::Result<DeliveryAccount> {
    ...
    pub async fn get_delivery_positions(&self, params: DeliveryPositionsRequest) -> crate::gateio::Result<Vec<DeliveryPosition>> {
    ...
    pub async fn get_delivery_position(&self, settle: &str, contract: &str) -> crate::gateio::Result<DeliveryPosition> {
    ...
    pub async fn create_delivery_order(&self, request: CreateDeliveryOrderRequest) -> crate::gateio::Result<DeliveryOrder> {
    ...
    pub async fn list_delivery_orders(&self, params: ListDeliveryOrdersRequest) -> crate::gateio::Result<Vec<DeliveryOrder>> {
    ...
    pub async fn get_delivery_order(&self, settle: &str, order_id: &str) -> crate::gateio::Result<DeliveryOrder> {
    ...
    pub async fn cancel_all_delivery_orders(&self, settle: &str, contract: Option<&str>) -> crate::gateio::Result<Vec<DeliveryOrder>> {
    ...
    pub async fn cancel_delivery_order(&self, settle: &str, order_id: &str) -> crate::gateio::Result<DeliveryOrder> {
        let endpoint = format!("/delivery/{}/orders/{}", settle, order_id);
        self.delete(&endpoint).await
    }
    ...
    pub async fn set_delivery_position_leverage(&self, request: SetDeliveryLeverageRequest) -> crate::gateio::Result<DeliveryLeverageResponse> {
        let endpoint = format!("/delivery/{}/positions/{}/leverage", request.settle, request.contract);
        self.post(&endpoint, &request).await
    }
    ...
    pub async fn get_delivery_settlements(&self, settle: &str, contract: Option<&str>, limit: Option<i32>) -> crate::gateio::Result<Vec<DeliverySettlement>> {
    ...
    pub async fn update_delivery_position_margin(&self, request: UpdateDeliveryPositionMarginRequest) -> crate::gateio::Result<DeliveryPositionMarginResponse> {
        let endpoint = format!("/delivery/{}/positions/{}/margin", request.settle, request.contract);
        self.post(&endpoint, &request).await
    }
    ...
    pub async fn update_delivery_position_risk_limit(&self, request: UpdateDeliveryRiskLimitRequest) -> crate::gateio::Result<DeliveryRiskLimitResponse> {
        let endpoint = format!("/delivery/{}/positions/{}/risk_limit", request.settle, request.contract);
        self.post(&endpoint, &request).await
    }
    ...
    pub async fn get_delivery_my_trades(&self, params: DeliveryMyTradesRequest) -> crate::gateio::Result<Vec<DeliveryTrade>> {
    ...
    pub async fn get_delivery_position_close_history(&self, params: DeliveryPositionCloseHistoryRequest) -> crate::gateio::Result<Vec<DeliveryPositionClose>> {
    ...
    pub async fn get_delivery_liquidation_history(&self, params: DeliveryLiquidationHistoryRequest) -> crate::gateio::Result<Vec<DeliveryLiquidation>> {
    ...
    pub async fn get_delivery_account_book(&self, params: DeliveryAccountBookRequest) -> crate::gateio::Result<Vec<DeliveryAccountBookEntry>> {
    ...
    pub async fn create_delivery_price_triggered_order(&self, request: CreateDeliveryPriceOrderRequest) -> crate::gateio::Result<DeliveryPriceOrder> {
    ...
    pub async fn list_delivery_price_triggered_orders(&self, params: ListDeliveryPriceOrdersRequest) -> crate::gateio::Result<Vec<DeliveryPriceOrder>> {
    ...
    pub async fn get_delivery_price_triggered_order(&self, settle: &str, order_id: &str) -> crate::gateio::Result<DeliveryPriceOrder> {
    ...
    pub async fn cancel_delivery_price_triggered_order(&self, settle: &str, order_id: &str) -> crate::gateio::Result<DeliveryPriceOrder> {
        let endpoint = format!("/delivery/{}/price_orders/{}", settle, order_id);
        self.delete(&endpoint).await
    }
    ...
    pub async fn cancel_all_delivery_price_triggered_orders(&self, settle: &str, contract: Option<&str>) -> crate::gateio::Result<Vec<DeliveryPriceOrder>> {
