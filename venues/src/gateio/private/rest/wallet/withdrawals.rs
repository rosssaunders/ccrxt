...
impl RestClient {
    ...
    ///
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#retrieve-withdrawal-records)
    ///
    ...
    pub async fn spot_get_withdrawals(
        &self,
    ...
    ///
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#retrieve-withdrawal-status)
    ///
    /// Rate limit: 100 requests per second
    ///
    /// # Arguments
    ...
    pub async fn spot_get_withdrawal_fees(
        &self,
        params: WithdrawalFeesRequest,
    ) -> RestResult<Vec<WithdrawalFee>> {
