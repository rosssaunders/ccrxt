...
impl RestClient {
    ...
    pub async fn repay_all(&self, currency: &str) -> crate::gateio::Result<BorrowOrRepayResponse> {
    ...
    pub async fn get_max_borrowable(&self, currency: &str) -> crate::gateio::Result<MaxBorrowable> {
    ...
    ) -> crate::gateio::Result<Vec<LoanInterestRecord>> {
