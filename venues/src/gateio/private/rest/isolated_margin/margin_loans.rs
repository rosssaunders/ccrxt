...
impl RestClient {
    ...
    pub async fn spot_get_loan(&self, loan_id: &str) -> RestResult<Loan> {
    ...
    pub async fn spot_get_loan_record(
        &self,
        loan_record_id: &str,
        params: LoanRecordsRequest,
    ) -> RestResult<LoanRecord> {
    ...
    pub async fn spot_modify_loan_record(
        &self,
        loan_record_id: &str,
        auto_renew: bool,
    ) -> RestResult<LoanRecord> {
