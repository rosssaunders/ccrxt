...
impl RestClient {
    ...
    pub async fn list_margin_loans(&self, params: ListLoansRequest) -> crate::gateio::Result<Vec<Loan>> {
    ...
    pub async fn modify_loan(&self, loan_id: &str, request: ModifyLoanRequest) -> crate::gateio::Result<Loan> {
        let endpoint = format!("/margin/loans/{}", loan_id);
    ...
    pub async fn cancel_loan(&self, loan_id: &str, currency: &str, currency_pair: &str) -> crate::gateio::Result<Loan> {
        let endpoint = format!("/margin/loans/{}?currency={}&currency_pair={}", loan_id, currency, currency_pair);
    ...
    pub async fn repay_loan(&self, loan_id: &str, request: RepayLoanRequest) -> crate::gateio::Result<Vec<LoanRepayment>> {
    ...
    pub async fn get_repayment_records(&self, loan_id: &str) -> crate::gateio::Result<Vec<LoanRepayment>> {
        let endpoint = format!("/margin/loans/{}/repayment", loan_id);
        self.get(&endpoint).await
    }
    ...
    pub async fn get_loan_records(&self, params: LoanRecordsRequest) -> crate::gateio::Result<Vec<LoanRecord>> {
    ...
    pub async fn get_loan_record(&self, loan_record_id: &str, params: LoanRecordsRequest) -> crate::gateio::Result<LoanRecord> {
    ...
    pub async fn modify_loan_record(&self, loan_record_id: &str, auto_renew: bool) -> crate::gateio::Result<LoanRecord> {
        let endpoint = format!("/margin/loan_records/{}", loan_record_id);
