...
impl RestClient {
    ...
    pub async fn get_futures_accounts(&self, params: FuturesAccountsRequest) -> crate::gateio::Result<FuturesAccount> {
    ...
    pub async fn get_futures_positions(&self, params: FuturesPositionsRequest) -> crate::gateio::Result<Vec<FuturesPosition>> {
    ...
    pub async fn get_futures_position(&self, settle: &str, contract: &str) -> crate::gateio::Result<FuturesPosition> {
    ...
    pub async fn create_futures_order(&self, request: CreateFuturesOrderRequest) -> crate::gateio::Result<FuturesOrder> {
    ...
    pub async fn list_futures_orders(&self, params: ListFuturesOrdersRequest) -> crate::gateio::Result<Vec<FuturesOrder>> {
    ...
    pub async fn get_futures_order(&self, settle: &str, order_id: &str) -> crate::gateio::Result<FuturesOrder> {
    ...
    pub async fn cancel_all_futures_orders(&self, settle: &str, contract: Option<&str>, side: Option<&str>) -> crate::gateio::Result<Vec<FuturesOrder>> {
    ...
    pub async fn cancel_futures_order(&self, settle: &str, order_id: &str) -> crate::gateio::Result<FuturesOrder> {
        let endpoint = format!("/futures/{}/orders/{}", settle, order_id);
        self.delete(&endpoint).await
    }
    ...
    pub async fn set_position_leverage(&self, request: SetLeverageRequest) -> crate::gateio::Result<LeverageResponse> {
    ...
    pub async fn update_position_margin(&self, request: UpdatePositionMarginRequest) -> crate::gateio::Result<PositionMarginResponse> {
    ...
    pub async fn update_position_risk_limit(&self, request: UpdateRiskLimitRequest) -> crate::gateio::Result<RiskLimitResponse> {
    ...
    pub async fn switch_to_cross_margin(&self, settle: &str) -> crate::gateio::Result<()> {
        ...
        let request = CrossModeRequest { mode: "cross".to_string() };
    ...
    pub async fn set_dual_mode(&self, request: DualModeRequest) -> crate::gateio::Result<DualModeResponse> {
    ...
    pub async fn get_dual_mode_position(&self, settle: &str, contract: &str) -> crate::gateio::Result<DualModePosition> {
    ...
    pub async fn update_dual_mode_position_margin(&self, request: UpdateDualModeMarginRequest) -> crate::gateio::Result<DualModeMarginResponse> {
        let endpoint = format!("/futures/{}/dual_comp/positions/{}/margin", request.settle, request.contract);
        self.post(&endpoint, &request).await
    }
    ...
    pub async fn update_dual_mode_position_leverage(&self, request: UpdateDualModeLeverageRequest) -> crate::gateio::Result<DualModeLeverageResponse> {
        let endpoint = format!("/futures/{}/dual_comp/positions/{}/leverage", request.settle, request.contract);
        self.post(&endpoint, &request).await
    }
    ...
    pub async fn update_dual_mode_position_risk_limit(&self, request: UpdateDualModeRiskLimitRequest) -> crate::gateio::Result<DualModeRiskLimitResponse> {
        let endpoint = format!("/futures/{}/dual_comp/positions/{}/risk_limit", request.settle, request.contract);
        self.post(&endpoint, &request).await
    }
    ...
    pub async fn create_batch_futures_orders(&self, request: BatchOrdersRequest) -> crate::gateio::Result<Vec<BatchOrderResult>> {
    ...
    pub async fn cancel_batch_futures_orders(&self, request: BatchCancelOrdersRequest) -> crate::gateio::Result<Vec<BatchOrderResult>> {
    ...
    pub async fn amend_batch_futures_orders(&self, request: BatchAmendOrdersRequest) -> crate::gateio::Result<Vec<BatchOrderResult>> {
    ...
    pub async fn countdown_cancel_all_futures_orders(&self, request: CountdownCancelRequest) -> crate::gateio::Result<CountdownCancelResponse> {
    ...
    pub async fn list_futures_orders_by_time_range(&self, params: ListOrdersByTimeRangeRequest) -> crate::gateio::Result<Vec<FuturesOrder>> {
    ...
    pub async fn amend_futures_order(&self, request: AmendFuturesOrderRequest) -> crate::gateio::Result<FuturesOrder> {
    ...
    pub async fn create_price_triggered_order(&self, request: CreatePriceOrderRequest) -> crate::gateio::Result<PriceOrder> {
    ...
    pub async fn list_price_triggered_orders(&self, params: ListPriceOrdersRequest) -> crate::gateio::Result<Vec<PriceOrder>> {
    ...
    pub async fn get_price_triggered_order(&self, settle: &str, order_id: &str) -> crate::gateio::Result<PriceOrder> {
    ...
    pub async fn cancel_price_triggered_order(&self, settle: &str, order_id: &str) -> crate::gateio::Result<PriceOrder> {
        let endpoint = format!("/futures/{}/price_orders/{}", settle, order_id);
        self.delete(&endpoint).await
    }
    ...
    pub async fn cancel_all_price_triggered_orders(&self, settle: &str, contract: Option<&str>) -> crate::gateio::Result<Vec<PriceOrder>> {
    ...
    pub async fn get_futures_my_trades(&self, params: MyTradesRequest) -> crate::gateio::Result<Vec<FuturesTrade>> {
    ...
    pub async fn get_futures_my_trades_by_time_range(&self, params: MyTradesByTimeRangeRequest) -> crate::gateio::Result<Vec<FuturesTrade>> {
    ...
    pub async fn get_futures_position_close_history(&self, params: PositionCloseHistoryRequest) -> crate::gateio::Result<Vec<PositionClose>> {
    ...
    pub async fn get_futures_liquidation_history(&self, params: LiquidationHistoryRequest) -> crate::gateio::Result<Vec<Liquidation>> {
    ...
    pub async fn get_futures_liquidation_orders(&self, params: LiquidationOrdersRequest) -> crate::gateio::Result<Vec<LiquidationOrder>> {
    ...
    pub async fn get_futures_auto_deleveraging_history(&self, params: AutoDeleveragingRequest) -> crate::gateio::Result<Vec<AutoDeleveraging>> {
    ...
    pub async fn get_futures_account_book(&self, params: FuturesAccountBookRequest) -> crate::gateio::Result<Vec<FuturesAccountBookEntry>> {
    ...
    pub async fn get_futures_fee_rates(&self, params: FuturesFeeRatesRequest) -> crate::gateio::Result<FuturesFeeRates> {
