...
use super::{
    RestClient, RestResult, amend_order::AmendFuturesOrderRequest, batch_orders::BatchOrderResult,
};
...
impl RestClient {
    ...
    ///
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#amend-multiple-open-orders-in-batch)
    ///
