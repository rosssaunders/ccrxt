...
impl RestClient {
    ...
    ///
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#list-futures-orders)
    ///
    ...
    ) -> RestResult<Vec<FuturesOrder>> {
        let endpoint = format!("{}/{}/orders", ENDPOINT_FUTURES_PREFIX, params.settle);
