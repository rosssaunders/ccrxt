...
use super::{RestClient, RestResult, position::FuturesPosition};
...
impl RestClient {
    ...
    ///
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#list-all-positions-of-a-user)
    ///
    ...
    ) -> RestResult<Vec<FuturesPosition>> {
        let endpoint = format!("{}/{}/positions", ENDPOINT_FUTURES_PREFIX, params.settle);
