...
use super::{RestClient, RestResult, create_order::CreateFuturesOrderRequest};
...
impl RestClient {
    ...
    ///
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#create-a-batch-of-futures-orders)
    ///
    ...
    ///
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#cancel-a-batch-of-open-orders)
    ///
    /// Rate limit: 100 requests per second
    ///
    /// # Arguments
