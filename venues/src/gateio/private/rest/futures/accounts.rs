...
impl RestClient {
    ...
    ///
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#query-futures-account)
    ///
    ...
    ) -> RestResult<FuturesAccount> {
        let endpoint = format!("{}/{}/accounts", ENDPOINT_FUTURES_PREFIX, params.settle);
