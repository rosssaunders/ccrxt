...
impl RestClient {
    ...
    ///
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#enable-or-disable-dual-mode)
    ///
    ...
    /// # Returns
    /// Dual mode status
    pub async fn set_dual_mode(&self, request: DualModeRequest) -> RestResult<DualModeResponse> {
