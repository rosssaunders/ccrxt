...
impl RestClient {
    ...
    pub async fn get_margin_accounts(&self, params: MarginAccountsRequest) -> crate::gateio::Result<Vec<MarginAccount>> {
    ...
    pub async fn get_margin_account_book(&self, params: MarginAccountBookRequest) -> crate::gateio::Result<Vec<MarginAccountBookEntry>> {
