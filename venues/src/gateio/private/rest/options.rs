...
impl RestClient {
    ...
    ) -> crate::gateio::Result<Vec<OptionsPosition>> {
    ...
    pub async fn get_options_position(
        &self,
        contract: &str,
    ) -> crate::gateio::Result<OptionsPosition> {
    ...
    ) -> crate::gateio::Result<OptionsOrder> {
    ...
    ) -> crate::gateio::Result<Vec<OptionsOrder>> {
    ...
    ) -> crate::gateio::Result<MMPSettings> {
    ...
    ) -> crate::gateio::Result<Vec<OptionsAccountBookEntry>> {
    ...
    ) -> crate::gateio::Result<Vec<OptionsPositionClose>> {
    ...
    ) -> crate::gateio::Result<Vec<OptionsMyTrade>> {
    ...
    pub async fn countdown_cancel_options_orders(
        ...
        timeout: i32,
        underlying: Option<&str>,
    ) -> crate::gateio::Result<serde_json::Value> {
