...
impl RestClient {
    ...
    pub async fn get_funding_accounts(&self, params: FundingAccountsRequest) -> crate::gateio::Result<Vec<FundingAccount>> {
        self.get_with_query("/margin/funding_accounts", &params).await
    }
    ...
    pub async fn get_transferable(&self, params: TransferableRequest) -> crate::gateio::Result<TransferableAmount> {
    ...
    /// currency and currency pair in margin trading.
    pub async fn get_borrowable(&self, params: BorrowableRequest) -> crate::gateio::Result<BorrowableAmount> {
    ...
    pub async fn update_auto_repay(&self, params: AutoRepayRequest) -> crate::gateio::Result<AutoRepaySetting> {
