use super::{RestClient, RestResult, loan::BorrowOrRepayResponse};
...
impl RestClient {
    ...
    ///
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#repay-all)
    pub async fn repay_all(&self, currency: &str) -> RestResult<BorrowOrRepayResponse> {
