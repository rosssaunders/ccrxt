use super::{RestClient, RestResult, unified_mode_types::UnifiedModeResponse};
...
impl RestClient {
    ...
    ///
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#get-unified-mode)
    pub async fn get_unified_mode(&self) -> RestResult<UnifiedModeResponse> {
