use super::{RestClient, RestResult, unified_margin::UnifiedMarginCurrencyPair};
...
impl RestClient {
    ...
    ///
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#get-unified-margin-currency-pair)
    pub async fn get_unified_margin_currency_pair(
        &self,
        currency_pair: &str,
    ) -> RestResult<UnifiedMarginCurrencyPair> {
