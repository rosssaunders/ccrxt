use super::{RestClient, RestResult, transferable::UnifiedTransferableResponse};
...
impl RestClient {
    ...
    ///
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#get-unified-transferables)
    pub async fn get_unified_transferables(&self) -> RestResult<Vec<UnifiedTransferableResponse>> {
