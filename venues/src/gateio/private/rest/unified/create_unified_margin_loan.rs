use super::{
    ...
    unified_margin::{CreateUnifiedMarginLoanRequest, UnifiedMarginLoan},
};
...
impl RestClient {
    ...
    ///
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#create-unified-margin-loan)
    pub async fn create_unified_margin_loan(
        &self,
        request: CreateUnifiedMarginLoanRequest,
    ) -> RestResult<UnifiedMarginLoan> {
