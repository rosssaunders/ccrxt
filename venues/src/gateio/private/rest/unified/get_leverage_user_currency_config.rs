use super::{RestClient, RestResult, leverage::LeverageConfig};
...
impl RestClient {
    ...
    ///
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#get-leverage-user-currency-config)
    pub async fn get_leverage_user_currency_config(
        &self,
        currency: Option<&str>,
    ) -> RestResult<Vec<LeverageConfig>> {
