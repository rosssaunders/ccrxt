...
impl RestClient {
    ...
    ///
    /// [docs](https://www.gate.io/docs/developers/apiv4/en/#update-position-margin)
    ///
...
mod tests {
    ...
    fn test_delivery_position_margin_endpoint() {
        assert_eq!(
            DELIVERY_POSITION_MARGIN_ENDPOINT,
    ...
    fn test_position_margin_endpoint_construction() {
        ...
        assert_eq!(
            endpoint,
            "/delivery/USDT/positions/BTC_USDT_20240315/margin"
        );
    }
    ...
    fn test_position_margin_endpoint_different_params() {
        let test_cases = vec![
            (
                "BTC",
                "BTC_USDT_20240315",
                "/delivery/BTC/positions/BTC_USDT_20240315/margin",
            ),
            (
                "USDT",
                "ETH_USDT_20240415",
                "/delivery/USDT/positions/ETH_USDT_20240415/margin",
            ),
            (
                "ETH",
                "SOL_ETH_20240515",
                "/delivery/ETH/positions/SOL_ETH_20240515/margin",
            ),
        ];
    ...
    fn test_position_margin_endpoint_with_different_settlements() {
        ...
        for settle in settlements {
            ...
            assert_eq!(
                endpoint,
                format!("/delivery/{}/positions/{}/margin", settle, contract)
            );
        }
    }
