...
pub enum Errors {
    ...
    /// Rate limit error
    RateLimitError(crate::coinbase::rate_limit::RateLimitError),
...
impl From<crate::coinbase::rate_limit::RateLimitError> for Errors {
    fn from(err: crate::coinbase::rate_limit::RateLimitError) -> Self {
