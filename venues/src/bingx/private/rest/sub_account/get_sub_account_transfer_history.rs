...
use crate::bingx::{
    EndpointType, PrivateRestClient as RestClient, RestResult, enums::SubAccountTransferType,
};
...
impl RestClient {
    ...
    ///
    /// [docs](https://bingx-api.github.io/docs/#/en-us/common/sub-account#Get%20sub-account%20transfer%20history)
    ///
    /// Rate limit: UID 1/s
    ///
    /// # Arguments
