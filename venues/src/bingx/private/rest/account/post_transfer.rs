...
pub struct AssetTransferNewRequest {
    /// From account (required): fund=Funding Account, spot=Spot Account, stdFutures=Standard Contract, coinMPerp=COIN-M Perpetual Future, USDTMPerp=Perpetual Future
    pub from_account: String,

    /// To account (required): fund=Funding Account, spot=Spot Account, stdFutures=Standard Contract, coinMPerp=COIN-M Perpetual Future, USDTMPerp=Perpetual Future
    pub to_account: String,

    /// Coin name e.g. USDT (required)
    pub asset: String,

    /// Transfer amount (required)
    pub amount: Decimal,

    /// Execution window time (optional) - cannot be greater than 60000
    #[serde(skip_serializing_if = "Option::is_none")]
    pub recv_window: Option<i64>,

    /// Current timestamp e.g. 1658748648396 (required)
    pub timestamp: i64,
}
...
impl RestClient {
    ...
    ///
    /// [docs](https://bingx-api.github.io/docs/#/en-us/spot/account-api.html#Asset%20Transfer%20New)
    ///
