...
use crate::bingx::{DepositStatus, EndpointType, PrivateRestClient as RestClient, RestResult};

const DEPOSIT_RECORDS_ENDPOINT: &str = "/openApi/api/v3/capital/deposit/hisrec";
...
pub struct GetDepositRecordsRequest {
    ...
    /// Status filter (0-In progress, 6-Chain uploaded, 1-Completed) (optional)
    #[serde(skip_serializing_if = "Option::is_none")]
