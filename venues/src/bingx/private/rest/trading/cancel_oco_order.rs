...
pub struct CancelOcoOrderRequest {
    /// The order ID of the limit order or the stop-limit order. Either orderId or clientOrderId must be provided (optional)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub order_id: Option<String>,

    /// The User-defined order ID of the limit order or the stop-limit order (optional)
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl RestClient {
    ...
    ///
    /// [docs](https://bingx-api.github.io/docs/#/en-us/spot/trade-api.html#Cancel%20an%20OCO%20Order%20List)
    ///
