...
const COMMISSION_RATE_ENDPOINT: &str = "/openApi/spot/v1/user/commissionRate";
...
impl RestClient {
    ...
    ///
    /// [docs](https://bingx-api.github.io/docs/#/en-us/spot/trade-api.html#Query%20Trading%20Commission%20Rate)
    ///
