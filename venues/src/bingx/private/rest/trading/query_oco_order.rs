...
use crate::bingx::{
    EndpointType, PrivateRestClient as RestClient, RestResult, enums::OcoOrderStatus,
};
...
impl RestClient {
    ...
    ///
    /// [docs](https://bingx-api.github.io/docs/#/en-us/spot/trade-api.html#Query%20OCO%20order%20information)
    ///
    /// Rate limit: UID 10/s
    ///
    /// # Arguments
