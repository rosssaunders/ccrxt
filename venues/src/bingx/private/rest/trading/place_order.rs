...
pub struct PlaceOrderRequest {
    ...
    /// Order trigger price, used for TAKE_STOP_LIMITED,TAKE_STOP_MARKET, TRIGGER_LIMITED, TRIGGER_Market type orders (required for applicable types)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub stop_price: Option<String>,

    /// Original quantity, e.g., 0.1BTC (optional)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub quantity: Option<String>,

    /// Quote order quantity, e.g., 100USDT, if quantity and quoteOrderQty are input at the same time, quantity will be used first, and quoteOrderQty will be discarded (optional)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub quote_order_qty: Option<String>,

    /// Price, e.g., 10000USDT (optional)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub price: Option<String>,

    /// Only letters, numbers and _,Customized order ID for users, with a limit of characters from 1 to 40. Different orders cannot use the same newClientOrderId,Only supports a query range of 2 hours (optional)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub new_client_order_id: Option<String>,

    /// Time in force, currently supports PostOnly, GTC, IOC, FOK. Default is GTC if not specified (optional)
    #[serde(skip_serializing_if = "Option::is_none")]
