...
use super::{errors::Errors, rate_limit::EndpointType};

/// BitMart-specific rate limiter trait
///
/// This trait defines the interface for BitMart rate limiting with endpoint-specific controls.
/// BitMart has different rate limits per endpoint type (System, FundingAccount, etc.)
/// It can be implemented for both native and WASM environments.
#[async_trait]
pub trait BitMartRateLimiter: Send + Sync {
