...
mod tests {
    ...
    fn test_kline_data_parsing() {
        ...
        assert_eq!(
            GetLatestKlineResponse::timestamp(&kline_data),
            Some("1689736680")
        );
        assert_eq!(
            GetLatestKlineResponse::open_price(&kline_data),
            Some("3.721")
        );
        assert_eq!(
            GetLatestKlineResponse::high_price(&kline_data),
            Some("3.743")
        );
        assert_eq!(
            GetLatestKlineResponse::low_price(&kline_data),
            Some("3.677")
        );
        assert_eq!(
            GetLatestKlineResponse::close_price(&kline_data),
            Some("3.708")
        );
        assert_eq!(
            GetLatestKlineResponse::volume(&kline_data),
            Some("22698348.04828491")
        );
        assert_eq!(
            GetLatestKlineResponse::quote_volume(&kline_data),
    ...
    fn test_get_latest_kline_response_structure() {
        ...
        assert_eq!(
            GetLatestKlineResponse::timestamp(&response.0[1]),
            Some("1689736620")
        );
    }
    ...
    fn test_response_json_parsing() {
        ...
        assert_eq!(
            GetLatestKlineResponse::open_price(&response.0[0]),
            Some("3.721")
        );
        assert_eq!(
            GetLatestKlineResponse::timestamp(&response.0[1]),
        ...
        assert_eq!(
            GetLatestKlineResponse::open_price(&response.0[1]),
            Some("3.731")
        );
    }
