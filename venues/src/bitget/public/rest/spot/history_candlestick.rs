...
use crate::bitget::{
    ApiError, CandlestickGranularity, PublicRestClient as RestClient, RestResponse,
};
...
impl RestClient {
    ...
    ///
    /// [docs](https://www.bitget.com/api-doc/spot/market/Get-Historical-Candlestick-Data)
    ///
