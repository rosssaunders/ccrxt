...
impl GetHistoryCandlestickRequest {
    ...
    pub fn new(symbol: impl Into<String>, granularity: CandlestickGranularity, end_time: u64) -> Self {
        Self {
            symbol: symbol.into(),
            granularity,
            end_time,
...
impl RestClient {
    ...
    /// # }
    /// ```
    pub async fn get_history_candlestick(&self, request: GetHistoryCandlestickRequest) -> Result<RestResponse<Vec<HistoryCandlestick>>, ApiError> {
