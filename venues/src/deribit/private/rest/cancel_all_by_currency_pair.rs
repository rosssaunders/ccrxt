...
use crate::deribit::{CurrencyPair, InstrumentKind, OrderType, EndpointType, RestResult};
...
pub struct CancelAllByCurrencyPairResponse {
...
impl RestClient {
    ...
    ///
    /// See: <https://docs.deribit.com/v2/#private-cancel_all_by_currency_pair>
    ///
