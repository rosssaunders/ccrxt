...
mod tests {
    ...
    use super::*;
    use crate::deribit::{AccountTier, AddressStatus, credentials::Credentials};
    ...
    async fn test_get_address_book_method_exists() {
        ...
        let _ = PrivateRestClient::get_address_book;
        ...
        for currency in currencies {
            for address_type in &types {
                ...
                match address_type {
                    ...
                    AddressBookType::Other(s) => {
                        assert_eq!(json_value.get("type").unwrap(), s)
                    }
                }
            }
        }
