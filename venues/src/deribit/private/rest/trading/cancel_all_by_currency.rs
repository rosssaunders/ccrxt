...
use crate::deribit::{
    Currency, EndpointType, InstrumentKind, JsonRpcResult, OrderType, PrivateRestClient, RestResult,
};
...
impl PrivateRestClient {
    ...
    ///
    /// [docs](https://docs.deribit.com/v2/#private-cancel_all_by_currency)
    ///
...
mod tests {
    ...
    async fn test_cancel_all_by_currency_method_exists() {
        ...
        let _ = PrivateRestClient::cancel_all_by_currency;
