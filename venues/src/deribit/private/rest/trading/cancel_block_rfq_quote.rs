...
use super::super::block_rfq::add_block_rfq_quote::AddBlockRfqQuoteResult;
...
impl PrivateRestClient {
    ...
    ///
    /// [docs](https://docs.deribit.com/v2/#private-cancel_block_rfq_quote)
    ///
...
mod tests {
    ...
    async fn test_cancel_block_rfq_quote_method_exists() {
        ...
        let _ = PrivateRestClient::cancel_block_rfq_quote;
