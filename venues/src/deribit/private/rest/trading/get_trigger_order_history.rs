...
use crate::deribit::{
    Currency, EndpointType, JsonRpcResult, OrderDirection, PrivateRestClient, RestResult,
    TradeOrderType, TriggerType,
};
...
mod tests {
    ...
    async fn test_get_trigger_order_history_method_exists() {
        ...
        let _ = PrivateRestClient::get_trigger_order_history;
