...
use crate::deribit::{EndpointType, JsonRpcResult, PrivateRestClient, RestResult, Sorting};

/// REST API endpoint constant
const GET_USER_TRADES_BY_INSTRUMENT_ENDPOINT: &str = "private/get_user_trades_by_instrument";
...
pub type GetUserTradesByInstrumentResponse = JsonRpcResult<GetUserTradesByInstrumentResult>;
...
mod tests {
    ...
    async fn test_get_user_trades_by_instrument_method_exists() {
        ...
        let _ = PrivateRestClient::get_user_trades_by_instrument;
