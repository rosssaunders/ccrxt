...
use super::super::wallet::withdraw::WithdrawResponse;
use crate::deribit::{Currency, EndpointType, PrivateRestClient, RestResult};
...
mod tests {
    ...
    use super::*;
    use crate::deribit::{AccountTier, WithdrawalState, credentials::Credentials};
    ...
    async fn test_cancel_withdrawal_method_exists() {
        ...
        let _ = PrivateRestClient::cancel_withdrawal;
