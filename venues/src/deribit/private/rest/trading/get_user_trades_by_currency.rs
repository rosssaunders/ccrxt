...
use crate::deribit::{
    ...
    Liquidity, OrderDirection, OrderState, PrivateRestClient, RestResult, Sorting, TickDirection,
    TradeOrderType,
};

/// REST API endpoint constant
const GET_USER_TRADES_BY_CURRENCY_ENDPOINT: &str = "private/get_user_trades_by_currency";
...
impl PrivateRestClient {
    ...
    /// Scope: trade:read
    ///
    /// [docs](https://docs.deribit.com/v2/#private-get_user_trades_by_currency)
    ///
    ...
    pub async fn get_user_trades_by_currency(
        ...
        self.send_signed_request(
            GET_USER_TRADES_BY_CURRENCY_ENDPOINT,
            &request,
...
mod tests {
    ...
    async fn test_get_user_trades_by_currency_method_exists() {
        ...
        let _ = PrivateRestClient::get_user_trades_by_currency;
