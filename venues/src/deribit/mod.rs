...
pub mod public {
    ...
    pub use self::rest::GetBlockRfqTradesRequest;
    pub use self::rest::GetBlockRfqTradesResponse;
    pub use self::rest::GetBlockRfqTradesResult;
    pub use self::rest::BlockRfq;
    pub use self::rest::BlockRfqTrade;
    pub use self::rest::BlockRfqLeg;
    pub use self::rest::BlockRfqHedge;
...
pub use public::GetBlockRfqTradesRequest;
pub use public::GetBlockRfqTradesResponse;
pub use public::GetBlockRfqTradesResult;
pub use public::BlockRfq;
pub use public::BlockRfqTrade;
pub use public::BlockRfqLeg;
pub use public::BlockRfqHedge;
