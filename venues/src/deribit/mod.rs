...
pub mod private {
    ...
    pub use self::rest::{
        DepositId, IndexName, Originator, ResetMmpRequest, ResetMmpResponse, SendRfqRequest, SendRfqResponse, SetClearanceOriginatorRequest, SetClearanceOriginatorResponse, SetClearanceOriginatorResult,
