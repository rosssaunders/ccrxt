...
use super::{Errors, rate_limit::EndpointType};

/// OKX-specific rate limiter trait
///
/// This trait defines the interface for OKX rate limiting with endpoint-specific controls.
/// It can be implemented for both native and WASM environments.
#[async_trait]
pub trait OkxRateLimiter: Send + Sync {
