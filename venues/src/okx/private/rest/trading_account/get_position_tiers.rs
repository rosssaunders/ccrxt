...
impl RestClient {
    /// Get position tiers
    ///
    /// [docs](https://www.okx.com/docs-v5/en/#trading-account-rest-api-get-position-tiers)
    ///
    /// # Arguments
...
mod tests {
    ...
    fn test_position_tier_deserialization() {
        ...
        let response: ApiResponse<PositionTier> = serde_json::from_str(response_json).unwrap();
