...
mod tests {
    ...
    #[test]
    fn test_open_interest_data_structure() {
        ...
        let open_interest_data: OpenInterestData = serde_json::from_value(open_interest_json).unwrap();
        assert_eq!(open_interest_data.inst_type, "SWAP");
        assert_eq!(open_interest_data.inst_id, "BTC-USD-SWAP");
        assert_eq!(open_interest_data.oi, "123456");
        assert_eq!(open_interest_data.ts, "1597026383085");
    }
