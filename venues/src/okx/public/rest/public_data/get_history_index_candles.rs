...
use crate::okx::{Bar, EndpointType, RestResult, public_client::RestClient};

const GET_HISTORY_INDEX_CANDLES_ENDPOINT: &str = "api/v5/market/history-index-candles";
...
mod tests {
    ...
    fn test_request_serialization_roundtrip() {
        ...
        let deserialized: GetHistoryIndexCandlesRequest =
