...
use crate::okx::{
    EndpointType, InstrumentState, InstrumentType, RestResult, public_client::RestClient,
};
...
mod tests {
    ...
    fn test_get_instruments_response_structure() {
        ...
        let response: ApiResponse<Instrument> = serde_json::from_value(response_json).unwrap();
