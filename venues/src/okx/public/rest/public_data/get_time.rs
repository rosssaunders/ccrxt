...
mod tests {
    ...
    fn test_get_time_response_structure() {
        ...
        let response: ApiResponse<TimeData> = serde_json::from_value(response_json).unwrap();
    ...
    async fn test_get_time_method_compilation() {
        ...
        let rest_client = super::RestClient::new("https://www.okx.com", http_client, rate_limiter);
