...
pub mod public {
    ...
    pub use self::rest::{
        ...
        DiscountDetail, DiscountRateInterestFreeQuota, EstimatedPriceData, EstimatedSettlementInfo, ExchangeRate,
        ...
        GetEstimatedPriceResponse, GetEstimatedSettlementInfoRequest,
        GetEstimatedSettlementInfoResponse, GetFundingRateHistoryRequest, GetFundingRateHistoryResponse,
...
pub use public::{
    ...
    EstimatedPriceData, EstimatedSettlementInfo, ExchangeRate, ExchangeRateResponse, FundingRate, FundingRateHistory,
