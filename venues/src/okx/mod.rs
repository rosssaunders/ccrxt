...
pub mod public {
    ...
    pub use self::rest::{
        BasicInterestRate, GetInterestRateLoanQuotaRequest, GetInterestRateLoanQuotaResponse, InterestRateLoanQuotaData, RegularInterestRate, VipInterestRate,
    };
    pub use self::rest::{ConvertContractCoinData, ConvertContractCoinRequest, ConvertContractCoinResponse};
    pub use self::rest::{DeliveryExerciseDetail, DeliveryExerciseHistory, GetDeliveryExerciseHistoryRequest, GetDeliveryExerciseHistoryResponse};
    pub use self::rest::{DiscountDetail, DiscountRateInterestFreeQuota, GetDiscountRateInterestFreeQuotaRequest, GetDiscountRateInterestFreeQuotaResponse};
    ...
    pub use self::rest::{FundingRateHistory, GetFundingRateHistoryRequest, GetFundingRateHistoryResponse};
    ...
    pub use self::rest::{GetSettlementHistoryRequest, GetSettlementHistoryResponse, SettlementDetail, SettlementHistory};
...
pub mod private {
    ...
    pub use self::rest::RestClient;
    pub use self::rest::{
        AccountBalance, AccountConfig, AmendOrderRequest, AmendOrderResponse, AttachedAlgoOrder, BalanceDetail, CancelBatchOrdersResponse, CancelOrderRequest,
        CancelOrderResponse, CloseOrderAlgo, ClosePositionRequest, ClosePositionResponse, Fill, GetAccountBalanceRequest, GetAccountConfigRequest,
        GetFillsRequest, GetOrderHistoryRequest, GetOrderRequest, GetPendingOrdersRequest, GetPositionsRequest, IpRestriction, OkxApiResponse, OrderDetails,
...
pub use private::{
    AccountBalance, AccountConfig, AmendOrderRequest, AmendOrderResponse, AttachedAlgoOrder, BalanceDetail, CancelBatchOrdersResponse, CancelOrderRequest,
    CancelOrderResponse, CloseOrderAlgo, ClosePositionRequest, ClosePositionResponse, Fill, GetAccountBalanceRequest, GetAccountConfigRequest, GetFillsRequest,
...
pub use public::{DeliveryExerciseDetail, DeliveryExerciseHistory, GetDeliveryExerciseHistoryRequest, GetDeliveryExerciseHistoryResponse};
...
pub use public::{GetIndexComponentsRequest, GetIndexComponentsResponse, IndexComponent, IndexComponentData};
...
pub use public::{GetInsuranceFundRequest, GetInsuranceFundResponse, InsuranceFundData, InsuranceFundDetail};
