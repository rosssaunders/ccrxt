...
pub mod public {
    ...
    pub use self::rest::{
        ...
        DiscountDetail, DiscountRateInterestFreeQuota, EconomicEvent, EstimatedPriceData,
        ...
        GetEconomicCalendarRequest, GetEconomicCalendarResponse, GetEstimatedPriceRequest,
        ...
        SettlementDetail, SettlementHistory, TickBand, TimeData, UnderlyingData, VipInterestRate,
    };
}
...
pub use public::{
    ...
    DeliveryExerciseDetail, DeliveryExerciseHistory, EconomicEvent, EstimatedPriceData,
    ExchangeRate, ExchangeRateResponse, FundingRate, FundingRateHistory,
    GetDeliveryExerciseHistoryRequest, GetDeliveryExerciseHistoryResponse,
    GetEconomicCalendarRequest, GetEconomicCalendarResponse, GetEstimatedPriceRequest,
    GetEstimatedPriceResponse, GetFundingRateHistoryRequest, GetFundingRateHistoryResponse,
    ...
    GetIndexTickersResponse, GetInstrumentTickBandsRequest, GetInstrumentTickBandsResponse,
    GetInstrumentsRequest, GetInstrumentsResponse, GetInsuranceFundRequest,
    GetInsuranceFundResponse, GetMarkPriceCandlesHistoryRequest,
    ...
    GetOptSummaryRequest, GetOptSummaryResponse, GetPremiumHistoryRequest,
    GetPremiumHistoryResponse, GetPriceLimitRequest, GetPriceLimitResponse, GetTimeResponse,
    GetUnderlyingRequest, GetUnderlyingResponse, IndexCandle, IndexComponent, IndexComponentData,
    IndexTicker, Instrument, InstrumentTickBandData, InsuranceFundData, InsuranceFundDetail,
    MarkPrice, MarkPriceCandle, OpenInterest, OptSummary, PremiumHistory, PriceLimit,
    RestClient as PublicRestClient, TickBand, TimeData, UnderlyingData,
};
