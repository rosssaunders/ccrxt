...
/// Represents a single mark price kline/candlestick.
///
...
impl RestClient {
    ...
    ///
    /// [Official API docs](https://developers.binance.com/docs/derivatives/coin-margined-futures/market-data/rest-api/Mark-Price-Kline-Candlestick-Data)
    ///
