use super::enums::{
    ContractType, OrderType, RateLimitInterval, RateLimitType, SymbolStatus, TimeInForce, UnderlyingType,
};
use super::private_rest_client::BinanceCoinMPrivateRest;
...
impl BinanceCoinMPrivateRest {
    ...
    /// Weight: 1
    pub async fn get_exchange_info(&self) -> BinanceCoinMResult<ExchangeInfoResponse> {
        self.send_request(
