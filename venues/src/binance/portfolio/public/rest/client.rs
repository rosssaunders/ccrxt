// REST client for Binance Portfolio Margin public endpoints.
//
// Provides access to all public REST API endpoints for Binance Portfolio Margin.
...
pub struct RestClient {
    /// The base URL for the Binance Portfolio Margin public REST API (e.g., "<https://papi.binance.com>").
    ///
...
impl RestClient {
    /// Creates a new Binance Portfolio Margin public REST client.
    ///
    /// # Arguments
    /// * `base_url` - The base URL for the Binance Portfolio Margin public REST API (e.g., "<https://papi.binance.com>").
        ...
        T: serde::de::DeserializeOwned,
    {
        ...
        let body_data = match body {
            Some(b) => Some(serde_urlencoded::to_string(b).map_err(|e| crate::binance::portfolio::Errors::Error(format!("URL encoding error: {}", e)))?),
            None => None,
        };
