...
mod integration_tests {
    use crate::binance::portfolio_margin::{PortfolioMarginRateLimiter, OrderSide, OrderType, Errors, RateLimiter};
    ...
    fn test_portfolio_margin_rate_limits_constants() {
        ...
        assert_eq!(std::mem::size_of::<PortfolioMarginRateLimiter>(), std::mem::size_of::<RateLimiter>());
    }
}