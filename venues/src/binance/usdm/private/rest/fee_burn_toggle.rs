...
impl UsdmClient {
    ...
    ///
    /// [docs]: https://developers.binance.com/docs/derivatives/usds-margined-futures/account/rest-api/Toggle-BNB-Burn-On-Futures-Trading-And-Margin-Interest
    ///
    /// Rate limit: 1
    ///
    /// # Arguments
    ...
    pub async fn toggle_fee_burn(
        ...
        self.send_signed_request(TOGGLE_FEE_BURN_ENDPOINT, Method::POST, request, 1, false)
            .await
    }
}
