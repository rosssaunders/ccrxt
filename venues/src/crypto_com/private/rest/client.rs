...
mod tests {
    ...
    fn test_params_to_string_nested_object() {
        ...
        assert_eq!(params_to_string(&value), "order_id53287421324symbolBTC_USDT");
    }
    ...
    fn test_params_to_string_complex() {
        ...
        assert_eq!(params_to_string(&value), "array123nestedinnervaluesimpletest");
    }
    ...
    fn test_crypto_com_example_signing() {
        ...
        assert_eq!(expected_payload, "private/get-order-detail11test_api_keyorder_id532874213241587846358253");
    }
