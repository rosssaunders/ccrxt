...
impl GetIndexPriceKlineRequest {
    /// Create a new index price kline request
...
mod tests {
    ...
    #[test]
    fn test_get_index_price_kline_request_builder() {
        let request = GetIndexPriceKlineRequest::new(
            Category::Linear,
            "BTCUSDT".to_string(),
            Interval::Min60,
        )
